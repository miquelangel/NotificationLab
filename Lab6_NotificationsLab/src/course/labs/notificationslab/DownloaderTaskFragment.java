...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		DownloaderTask down = new DownloaderTask();

		
		// Retrieve arguments from DownloaderTaskFragment
		// Prepare them for use with DownloaderTask.
		Bundle args = this.getArguments();
        ArrayList<Integer> lista = args.getIntegerArrayList("friends");
...
//antes !=
							if (getResultCode() != MainActivity.IS_ALIVE) {
								...
								PendingIntent pending = PendingIntent.
										getActivity(mContext,MY_NOTIFICATION_ID,restartMainActivityIntent, PendingIntent.FLAG_UPDATE_CURRENT);
								...
								Notification.Builder notificationBuilder = new Notification.Builder(
										mContext).setContent(mContentView).
										setAutoCancel(true).
